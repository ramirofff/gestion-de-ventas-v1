-- Script de migración limpia - maneja errores de políticas existentes

-- 1. Crear tabla user_settings (solo si no existe)
...
-- 2. Crear tabla payment_sessions (solo si no existe)
...
-- 5. Limpiar políticas existentes primero
...
-- 6. Crear políticas para user_settings
...
-- 7. Crear políticas para payment_sessions
